...
public class S3Uploader {
    ...
    // 여러장의 파일 저장
    public List<String> saveFiles(User user, List<MultipartFile> multipartFiles) {
        ...
        for (MultipartFile multipartFile : multipartFiles) {
            ...
            String uploadedUrl = saveFile(user, multipartFile);
    ...
    public void deleteFile(String fileUrl) {
        ...
        try {
            ...
            throw new IllegalArgumentException("File delete fail");
        } catch (SdkClientException e) {
            log.error("AWS SDK client error : " + e.getMessage());
            throw new IllegalArgumentException("AWS SDK client error");
        }
    ...
    // 단일 파일 저장
    public String saveFile(User user, MultipartFile file) {
        String randomFilename = user.getId() + "/" +generateRandomFilename(file);
        ...
        try {
            ...
            throw new IllegalArgumentException("Amazon S3 error while uploading file");
        } catch (SdkClientException e) {
            log.error("AWS SDK client error while uploading file: " + e.getMessage());
            throw new IllegalArgumentException("AWS SDK client error while uploading file");
        } catch (IOException e) {
            log.error("IO error while uploading file: " + e.getMessage());
            throw new IllegalArgumentException("IO error while uploading file");
        }
