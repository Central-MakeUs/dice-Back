...
public class SpaceInfoDto {
    ...
    public SpaceInfoDto(Space space, Boolean isLiked, Object messageRoomId) {
        ...
        this.facilityInfo = space.getFacilityInfos().toString();
        this.notice = space.getNotices().toString();
    ...
    public static SpaceInfoDto of(Space space) {
        ...
        return SpaceInfoDto.builder()
                ...
                .facilityInfo(space.getFacilityInfos().toString())
                .notice(space.getNotices().toString())
